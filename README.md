...
`apps/backend` and `apps/landing` both use Next's default port `3000`. To run them at the same time, start the landing page on another port:
...
| `pnpm dev:landing` | Start the Next landing page |
